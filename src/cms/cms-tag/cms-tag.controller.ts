...
export class CmsTagController {
    constructor(private readonly cmsTagService: CmsTagService) {
    ...
    // ): Promise<Tag> {
    //     return this.cmsTagService.getTagById(id);
    // }
    ...
    async getAllTags(
        ...
        try {
            ...
            return this.cmsTagService.getAllTags(Requestor.ADMIN, sorting, pagination);
